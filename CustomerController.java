...
public class CustomerController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action == null) {
            ...
            request.getRequestDispatcher("/WEB-INF/Customer/customer-list.jsp").forward(request, response);

        } else if (action.equals("delete") && idParam != null) {
            ...
            request.getRequestDispatcher("/WEB-INF/Customer/edit-customer.jsp").forward(request, response);
        } else if (action.equals("detail") && idParam != null) {
            if (idParam != null) {
                int id = Integer.parseInt(idParam);
            ...
            request.getRequestDispatcher("/WEB-INF/Customer/detail-customer.jsp").forward(request, response);
