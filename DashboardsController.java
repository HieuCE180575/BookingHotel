 ...
 * @author nguye
 */
@WebServlet(name = "DashboardsController", urlPatterns = {"/Dashboards"})
public class DashboardsController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (acc == null) {
            ...
            int roleAcc = acc.getRole_A();
            if (roleAcc == 1) {
                request.setAttribute("bookings", bDao.getAllBookingByStatus("Pending"));
            } else {
                    request.setAttribute("bookings", bDao.getAllBookingByStatus(acc.getHotel().getHotelID(),"Pending"));
            }
